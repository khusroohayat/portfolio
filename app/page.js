        ...
        <section className="hero container">
          <div className="hero-blue">
            <div>
              ...
              <p>
              <span>A full-stack developer from Pakistan with 10+ years crafting robust web apps using ASP.NET, Blazor, React/Vue.js , and cloud platforms like Azure. Passionate about AI/LLMs , integrating OpenAI to automate workflows, and vibe coding —collaborative innovation for smarter, scalable solutions across healthcare, SaaS, and e-commerce.</span>
              </p>
