...
jest.mock("../HomeProjectsFilter", () => () => <div data-testid="home-projects-filter">[Project Filter]</div>);
// Mock ServicesSection
jest.mock("../ServicesSection", () => () => <div data-testid="services-section">[Services Section]</div>);
// Mock projects.json
...
describe("Home page", () => {
  it("renders hero section", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /Syed Khusroo Hayat/i })).toBeInTheDocument();
